    ...
    <body>
        ...
        <form action="Registro" method="post" class="p-4 border rounded bg-light">
            <div class="mb-3">
                ...
                <input type="text" id="nombre" name="id" class="form-control" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" id="anio_publicado" name="anio_publicado" class="form-control" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" id="cantidad_paginas" name="cantidad_paginas" class="form-control" required>
            </div>
